...
export const fetchComments = async ({ skip = 0, post_id, setParentCommentCountFun, comment_array = null }) => {
    ...
    await axios.post(import.meta.env.VITE_NODE_SERVER_DOMAIN + "/get-post-comments", { post_id, skip })
    .then(({ data }) => {
...
const CommentsContainer = () => {
    ...
    const loadMoreComments = async () => {
        ...
        let newCommentsArr = await fetchComments({ skip: totalParentCommentsLoaded, post_id: _id, setParentCommentCountFun: setTotalParentCommentsLoaded, comment_array: commentsArr })
