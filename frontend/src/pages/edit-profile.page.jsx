...
const EditProfile = () => {
    ...
    useEffect(() => {
        ...
        if(access_token){
            axios.post(import.meta.env.VITE_SERVER_DOMAIN + "/api/get-profile", { username: userAuth.username })
            .then(({ data }) => {
                setProfile(data);
                setLoading(false);
            })
    ...
    const handleImageUpload = (e) => {
        ...
        if (updatedProfileImg) {
            ...
            axios.post(import.meta.env.VITE_SERVER_DOMAIN + "/api/update-profile-img", formData, {
                headers: { 
