...
const PrivacyPolicy = () => {
    ...
    return (
        <>
            <Helmet>
                <title>christisking | Privacy Policy</title>
                <meta name="description" content="View christisking's privacy policy." />
                <meta name="keywords" content="christisking, christ is king, christisking.info, privacy, policy, privacy policy" />
                <meta property="og:title" content="christisking | Privacy Policy" />
                <meta property="og:description" content="View christisking's privacy policy." />
